...
/** رونویسی رایگانِ یک حساب تازه فقط Soniox خرج دارد — بدون مدل. */
 ...
 * رونویسی رایگانشان را هم می‌سوزانند.
 */
...
// سناریوی دوم: همان حساب‌ها سهمیهٔ رونویسی رایگانشان را هم می‌سوزانند. این
...
const b = report(
  `سناریوی ۲ — همان حساب‌ها رونویسی رایگانشان را هم می‌سوزانند (سوءاستفاده از لایهٔ رایگان)`,
  SHARE_TARGET - 1,
);

console.log("حالت واقعی — همان ده هم‌کلاسی هر هفته، رونویسی رایگان فقط یک بار");
for (const p of PACKAGES) {
