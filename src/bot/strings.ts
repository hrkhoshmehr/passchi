...
export const MORE_BTN = {
  timeline: "🕘 بخش‌بندی زمانی",
  transcript: "📄 رونوشت کامل",
  srt: "⏱ فایل زیرنویس",
} as const;

export const MORE_PROMPT =
  "📎 <b>اینا هم آماده‌ست، هر وقت خواستی</b>\n" +
  "<i>لازم نیست همین حالا — تو تاریخچه هم بهشون می‌رسی.</i>";

/** زیرنویسِ فایل‌ها، در یک جا تا با پیام‌های دیگر ناهماهنگ نشوند. */
export const CAPTION = {
  notes: "📕 جزوهٔ این جلسه",
  transcript: "📄 رونوشت کامل — همهٔ حرف‌های جلسه، پشت سر هم.",
  srt: "⏱ نسخهٔ زمان‌دار — برای پیدا کردن یک لحظه یا زیرنویسِ ویدیو.",
} as const;
...
export const MORE_GONE = {
  timeline: "بخش‌بندی زمانیِ این جلسه دیگر موجود نیست.",
  transcript: "رونوشت این جلسه دیگر روی سرور نیست.",
  srt: "فایل زیرنویس این جلسه دیگر روی سرور نیست.",
} as const;
