...
دیگه لازم نیست وقتتو تو کلاس تلف کنی. فقط صوت کلاسو برام بفرست، بهت می‌گم استاد چیکارا کرده تو کلاس — و اگه نکتهٔ امتحانی گفته یا تکلیف داده، اونو با عین جمله‌ش بهت می‌گم.

🎁 برای اینکه از دقت پیاده‌سازی مطمئن بشی، می‌تونی یه صوت تا ${toFaDigits(config.FREE_TRANSCRIPT_MINUTES)} دقیقه بفرستی تا متنش رو بهت بدم.
