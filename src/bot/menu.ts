...
جزوه رو برای بچه‌های کلاس بفرست؛ هرکی برش داره سهم همه کمتر می‌شه و تا سقف ${toFaDigits(Math.round(REFUND_CAP_PCT * 100))}٪ سکه‌هات برمی‌گرده. از اون طرف هم اگه هم‌کلاسیت جلسه‌ای رو به اشتراک گذاشته، تو فقط سهم خودتو می‌دی.
