 ...
 * افزایش دقیقاً بیست درصد نیست: ۲۰٫۳٪ ، ۲۰٫۱٪ و ۲۰٫۰٪. نردبان تخفیف هم
 * دست‌نخورده ماند — پکیج بزرگ‌تر همچنان سکهٔ ارزان‌تری دارد.
 */
export const PACKAGES: CoinPackage[] = [
  { id: "p1", coins: 700, price: 95_000, tag: "یک کلاس" },
  { id: "p2", coins: 2_000, price: 239_000, tag: "محبوب" },
  { id: "p3", coins: 5_000, price: 539_000, tag: "یک ترم" },
];
